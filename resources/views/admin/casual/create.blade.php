                        ...
                        <form action="{{ route('admin.casuals.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label for="official_identification_number">Id Number</label> <span
                                            class="text-danger">*</span>
                                        <input id="official_identification_number" type="text"
                                            name="official_identification_number"
                                            class="form-control @error('official_identification_number') is-invalid @enderror"
                                            value="{{ old('official_identification_number') }}">
