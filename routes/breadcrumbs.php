...
// Dashboard / casuals
Breadcrumbs::for('casuals', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('Casuals'), route('admin.casuals.index'));
});
